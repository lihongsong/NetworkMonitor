...
- (void)setupAttributedString{
    ...
    NSAttributedString *responseContentLength;
    ...
    NSAttributedString *responseContentLengthDetail;
    ...
    responseContentLength = [[NSMutableAttributedString alloc] initWithString:@"[responseContentLength]:" attributes:@{
                                                                                                                          NSFontAttributeName : titleFont,
                                                                                                                          NSForegroundColorAttributeName: titleColor
                                                                                                                          }];
    ...
    responseContentLengthDetail = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"%.2lfKB\n",[_model.responseContentLength doubleValue]/1024.0]
                                                                                 attributes:@{
                                                                                              NSFontAttributeName : detailFont,
                                                                                              NSForegroundColorAttributeName: detailColor
                                                                                              }];
    ...
    [attrText appendAttributedString:responseContentLength];
    [attrText appendAttributedString:responseContentLengthDetail];
